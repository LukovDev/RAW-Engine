...
// Объявление структур:
typedef struct Input_MouseState Input_MouseState;        // Ввод мыши.
typedef struct Input_KeyboardState Input_KeyboardState;  // Ввод клавиатуры.
typedef struct Input Input;  // Система ввода.
